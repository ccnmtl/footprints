...
urlpatterns = [
    ...
    path('search/book/', BookCopySearchView.as_view(),
         name='bookcopy-search-view'),
    path('search/', FootprintSearchView.as_view(), name='search'),
    ...
    # Batch Import
    path('batch/', include('footprints.batch.urls')),
