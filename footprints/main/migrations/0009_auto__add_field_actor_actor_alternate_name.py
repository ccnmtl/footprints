...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'main_actor', 'actor_alternate_name',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='actor_name', null=True, to=orm['main.Name']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Actor.actor_alternate_name'
        db.delete_column(u'main_actor', 'actor_alternate_name_id')
