...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field actor on 'Footprint'
        m2m_table_name = db.shorten_name(u'main_footprint_actor')
        ...
        db.create_unique(m2m_table_name, ['footprint_id', 'actor_id'])


    def backwards(self, orm):
        # Removing M2M table for field actor on 'Footprint'
        db.delete_table(db.shorten_name(u'main_footprint_actor'))
