...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Footprint.medium_description'
        db.add_column(u'main_footprint', 'medium_description',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Footprint.medium_description'
        db.delete_column(u'main_footprint', 'medium_description')
