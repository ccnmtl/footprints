...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Footprint.language'
        db.delete_column(u'main_footprint', 'language_id')

        # Adding M2M table for field language on 'Footprint'
        m2m_table_name = db.shorten_name(u'main_footprint_language')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('footprint', models.ForeignKey(orm[u'main.footprint'], null=False)),
            ('language', models.ForeignKey(orm[u'main.language'], null=False))
        ))
        db.create_unique(m2m_table_name, ['footprint_id', 'language_id'])


        # Changing field 'Name.sort_by'
        db.alter_column(u'main_name', 'sort_by', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):
        # Adding field 'Footprint.language'
        db.add_column(u'main_footprint', 'language',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Language'], null=True, blank=True),
                      keep_default=False)

        # Removing M2M table for field language on 'Footprint'
        db.delete_table(db.shorten_name(u'main_footprint_language'))


        # Changing field 'Name.sort_by'
        db.alter_column(u'main_name', 'sort_by', self.gf('django.db.models.fields.TextField')(default=datetime.datetime(2015, 1, 2, 0, 0)))
