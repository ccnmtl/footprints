...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Imprint.work'
        db.alter_column(u'main_imprint', 'work_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.WrittenWork'], null=True))

    def backwards(self, orm):

        # Changing field 'Imprint.work'
        db.alter_column(u'main_imprint', 'work_id', self.gf('django.db.models.fields.related.ForeignKey')(default=datetime.datetime(2014, 12, 23, 0, 0), to=orm['main.WrittenWork']))
    ...
    models = {
        ...
        u'main.actor': {
            ...
            'actor_name': ('django.db.models.fields.related.OneToOneField', [], {'blank': 'True', 'related_name': "'actor_name'", 'unique': 'True', 'null': 'True', 'to': u"orm['main.Name']"}),
        ...
        u'main.imprint': {
            ...
            'actor': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['main.Actor']", 'null': 'True', 'symmetrical': 'False'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'created_by': ('audit_log.models.fields.CreatingUserField', [], {'related_name': "'imprint_created_by'", 'to': u"orm['auth.User']"}),
            'date_of_publication': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['main.ExtendedDateFormat']", 'unique': 'True', 'null': 'True'}),
            'digital_object': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['main.DigitalObject']", 'null': 'True', 'symmetrical': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'language': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['main.Language']", 'null': 'True'}),
            'last_modified_by': ('audit_log.models.fields.LastUserField', [], {'related_name': "'imprint_last_modified_by'", 'to': u"orm['auth.User']"}),
            'modified_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'notes': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'place': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['main.Place']", 'null': 'True'}),
            'standardized_identifier': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['main.StandardizedIdentification']", 'null': 'True', 'symmetrical': 'False'}),
            'title': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'work': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['main.WrittenWork']", 'null': 'True'})
        },
        u'main.language': {
