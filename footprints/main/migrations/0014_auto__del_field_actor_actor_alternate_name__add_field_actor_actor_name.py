...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Actor.actor_alternate_name'
        db.delete_column(u'main_actor', 'actor_alternate_name')

        # Adding field 'Actor.actor_name'
        db.add_column(u'main_actor', 'actor_name',
                      self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='actor_name', unique=True, null=True, to=orm['main.Name']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Actor.actor_alternate_name'
        db.add_column(u'main_actor', 'actor_alternate_name',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Actor.actor_name'
        db.delete_column(u'main_actor', 'actor_name_id')
