...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'main_person', 'full_name',
                      self.gf('django.db.models.fields.TextField')(default='full name'),
                      keep_default=False)

        # Adding field 'Actor.alias'
        db.add_column(u'main_actor', 'alias',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'Footprint.title'
        db.alter_column(u'main_footprint', 'title', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):
        # Deleting field 'Person.full_name'
        db.delete_column(u'main_person', 'full_name')

        # Deleting field 'Actor.alias'
        db.delete_column(u'main_actor', 'alias')


        # Changing field 'Footprint.title'
        db.alter_column(u'main_footprint', 'title', self.gf('django.db.models.fields.TextField')(default='Footprint Title'))
