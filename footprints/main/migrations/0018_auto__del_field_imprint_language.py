...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Imprint.language'
        db.delete_column(u'main_imprint', 'language_id')

        # Adding M2M table for field language on 'Imprint'
        m2m_table_name = db.shorten_name(u'main_imprint_language')
        ...
        db.create_unique(m2m_table_name, ['imprint_id', 'language_id'])


    def backwards(self, orm):
        # Adding field 'Imprint.language'
        db.add_column(u'main_imprint', 'language',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Language'], null=True, blank=True),
                      keep_default=False)

        # Removing M2M table for field language on 'Imprint'
        db.delete_table(db.shorten_name(u'main_imprint_language'))
