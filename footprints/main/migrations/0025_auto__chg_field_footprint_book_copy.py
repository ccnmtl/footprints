...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Footprint.book_copy'
        db.alter_column(u'main_footprint', 'book_copy_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.BookCopy'], null=True))

    def backwards(self, orm):

        # Changing field 'Footprint.book_copy'
        db.alter_column(u'main_footprint', 'book_copy_id', self.gf('django.db.models.fields.related.ForeignKey')(default=datetime.datetime(2015, 1, 21, 0, 0), to=orm['main.BookCopy']))
    ...
    models = {
        ...
        u'main.footprint': {
            ...
            'book_copy': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['main.BookCopy']", 'null': 'True', 'blank': 'True'}),
