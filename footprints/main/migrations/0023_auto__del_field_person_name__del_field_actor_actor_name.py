...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'main_person', 'name',
                      self.gf('django.db.models.fields.related.OneToOneField')(default='Person Name', related_name='person_name', unique=True, to=orm['main.Name']),
                      keep_default=False)

        # Adding field 'Actor.actor_name'
        db.add_column(u'main_actor', 'actor_name',
                      self.gf('django.db.models.fields.related.OneToOneField')(related_name='actor_name', unique=True, null=True, to=orm['main.Name'], blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'main.person': {
            'Meta': {'ordering': "['full_name']", 'object_name': 'Person'},
