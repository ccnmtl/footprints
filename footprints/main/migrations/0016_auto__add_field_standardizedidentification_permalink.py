...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StandardizedIdentification.permalink'
        db.add_column(u'main_standardizedidentification', 'permalink',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StandardizedIdentification.permalink'
        db.delete_column(u'main_standardizedidentification', 'permalink')
