...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'main_person', 'date_of_birth')
        ...
        # Deleting field 'Actor.alternate_last_name'
        db.delete_column(u'main_actor', 'alternate_last_name')

        # Deleting field 'Actor.alternate_first_name'
        db.delete_column(u'main_actor', 'alternate_first_name')

        # Deleting field 'Actor.alternate_suffix'
        db.delete_column(u'main_actor', 'alternate_suffix')

        # Deleting field 'Actor.alternate_middle_name'
        db.delete_column(u'main_actor', 'alternate_middle_name')

        # Deleting field 'Imprint.publication_date'
        db.delete_column(u'main_imprint', 'publication_date')

        # Deleting field 'Footprint.recorded_date'
        db.delete_column(u'main_footprint', 'recorded_date')
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'main_person', 'date_of_birth',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)
        ...
        # Adding field 'Actor.alternate_last_name'
        db.add_column(u'main_actor', 'alternate_last_name',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Actor.alternate_first_name'
        db.add_column(u'main_actor', 'alternate_first_name',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Actor.alternate_suffix'
        db.add_column(u'main_actor', 'alternate_suffix',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Actor.alternate_middle_name'
        db.add_column(u'main_actor', 'alternate_middle_name',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Imprint.publication_date'
        db.add_column(u'main_imprint', 'publication_date',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Footprint.recorded_date'
        db.add_column(u'main_footprint', 'recorded_date',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'main.actor': {
            ...
            'actor_alternate_name': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'actor_name'", 'null': 'True', 'to': u"orm['main.Name']"}),
