...
class ExportFootprintListView(FootprintListView):
    def get_rows(self):
        ...
        for o in self.object_list:
            ...
            # Literary work LOC
            loc_id = unicode(o.book_copy.imprint.work.get_library_of_congress_identifier()).encode('utf-8')
            row.append(loc_id)
            ...
            if o.book_copy.imprint.has_oclc_number():
                row.append(unicode(o.book_copy.imprint.get_oclc_number().identifier))
            else:
                row.append('')
