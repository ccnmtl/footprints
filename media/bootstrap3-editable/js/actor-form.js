...
(function ($) {
    ...
    Actor.defaults = $.extend({}, $.fn.editabletypes.abstractinput.defaults, {
        tpl: '<div class="editable-actor">' +
                 '<label><span>Name: </span></label> <input type="text" class="form-control" name="person-autocomplete" placeholder="Type in an person\'s name"/>' +
                 '<label><span>Role: </span></label> <select class="form-control" name="role" placeholder="Type in a role name"/>' +
             '</div>',
        inputclass: ''
    });
